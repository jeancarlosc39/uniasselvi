        ...
        <v-card>
            ...
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-right body-1">{{ props.item.codbarras}}</td>
                    <td class="text-xs-right body-1">{{ props.item.valor}}</td>
        ...
        data: function () {
            return {
                ...
                headers: [
                    ...
                    {text: 'codbarras', value: 'codbarras'},
        ...
        methods: {
            ...
            getDataFromApi: function () {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    axios.get('/produtos/index', config)
                        .then((res) => {
            ...
            deleteAll(){
                ...
                axios.get('/produtos/destroyAll', config).then((res) => {
            ...
            insert () {
                if (this.$refs.form.validate()) {
                    ...
                    var app = this;
                    var novoProduto = app.produtos;
                    axios.patch('/produtos/store',  novoProduto)
                        .then( ( resp ) => {
                            console.log(resp.data)
                            if (resp.data =="codbarras"){
                                this.tipo = "warning"
                                this.showmensagem = false;
                                this.mensagem = 'Codigo de barras ja existe!'
                            } else{
            ...
            update () {
                if (this.$refs.form.validate()) {
                    ...
                    var app = this;
                    var novoProduto = app.produtos;
                    let uri = '/produtos/update/'+app.produtos.id;
                    axios.post(uri, novoProduto).then((resp) => {
                        this.mensagem = 'Adicionado com Sucesso!'
                        this.showmensagem = false;
                        this.tipo = "success"
                        this.close ()
            ...
            close () {
                this.dialog = false
                setTimeout(() => {
                    this.produtos = Object.assign({}, this.defaultItem)
                    this.editedIndex = -1
                }, 300)
            },
            save () {
                if (this.editedIndex > -1) {
                    Object.assign(this.items[this.editedIndex], this.produtos)
                    this.update()
                } else {
                    this.insert()
                }
